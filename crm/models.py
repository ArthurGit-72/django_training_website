...
class Order(models.Model):
    order_dt = models.DateTimeField(auto_now=True, verbose_name='Дата и время заказа') #создали поле создания заявки, поле id будет заполняться автоматически
    order_name = models.CharField(max_length=200, verbose_name='Имя') # создали поле с именем не более 200 знаков
    order_phone = models.CharField(max_length=200, verbose_name='Телефон') # создали поле с номером не более 200 знаков
